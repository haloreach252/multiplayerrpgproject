...
{
   public static readonly string MicroSplatVersion = "3.0";
   ...
   void InitModules()
   {
      if (modules.Count == 0)
      {
         ...
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/painting/microsplat-mesh-workflow-beta-120008?aid=1011l37NJ&pubref=25047", "microsplat_module_meshworkflow"));
#endif
