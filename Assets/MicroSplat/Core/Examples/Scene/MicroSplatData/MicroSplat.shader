...
UNITY_INSTANCING_BUFFER_END(Terrain)
   ...
   // ADVANCEDTERRAIN_ENTRYPOINT 
         ...
         #if _MESHCOMBINED
         SampleMeshCombined(albedo, normSAO, emisMetal, o.Alpha, SSSThickness, SSSTint, config, heightWeights);
         #endif
      ...
      #endif
      {
         ...
         o.Normal = half3(0, 0, 1);
            ...
            o.Albedo = l.Specular * saturate(l.Albedo.z+1);
         #else
            o.Albedo = l.Albedo;
            o.Normal = l.Normal;
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_Base1451492195"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_Base1451492195"
